...
function appearErrorPasswordRepeat() {
  passwordRepeatError.classList.add("error-appear");
  passwordRepeat.classList.add("error-border");
}
function disappearErrorPasswordRepeat() {
  passwordRepeatError.classList.remove("error-appear");
...
passwordRepeat.addEventListener("focusout", function () {
  if (!passwordRepeat.value) {
    appearErrorPasswordRepeat();
    passwordError.textContent = "비밀번호를 확인해주세요.";
  } else {
    disappearErrorPasswordRepeat();
  }
});
