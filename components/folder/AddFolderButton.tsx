...
import addPurpleImg from "@/src/image/add.svg";
import addWhiteImg from "@/src/image/addWhite.svg";
  ...
  return (
    <>
      <AddFolderBtn onClick={openModal}>
        ...
        <AddFolderImg src={addImg} alt="폴더 추가 버튼" width={100} height={100} />
      </AddFolderBtn>
...
const AddFolderImg = styled(Image)`
  width: 1.6rem;
  height: 1.6rem;
`;
