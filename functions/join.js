import { inputEmailEl, inputPswEl, showMessageByEmailEl, showMessageByPswEl, eyeOffIconEls, inputPswCheckEl,TEST_EMAIL } from './variablesEl.js'

function checkUserForJoin(e) {
  if (inputEmailEl.value && 
    inputEmailEl.value !== TEST_EMAIL) 
