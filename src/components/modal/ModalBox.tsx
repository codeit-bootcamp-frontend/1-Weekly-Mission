...
function ModalBox({ modal, closeModal, folderTitle = "", link, folderId, userID, selectedFolder }: ModalProps) {
  ...
  return (
    <Background onClick={handleClick}>
      <Container onClick={handleModalClick}>
        ...
        {modal === "폴더 추가" && selectedFolder && <AddModal selectedFolder={selectedFolder} />}
