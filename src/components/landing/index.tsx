    ...
    <Layout>
      <section className={styles.hero}>
        ...
        <div className={styles.hero__link}>
          <a href="signup.html">
            <button className={styles.hero__link__btn}>링크 추가하기</button>
          </a>
        </div>
        <div>
          <img src="images/landing.svg" alt="hero" className={styles.hero__image} />
        </div>
      </section>
      <section>
        <ul className={styles.contents}>
          <li className={styles.content}>
            ...
            <img className={styles.content__image} src="images/contents1.svg" alt="contents" />
          </li>
          <li className={styles.content}>
            <h2 className={styles.content__info__title}>
              링크를 폴더로
            ...
            <img className={styles.content__image} src="images/contents2.svg" alt="contents" />
          </li>
          <li className={styles.content}>
            <h2 className={styles.content__info__title}>
              저장한 링크를
            ...
            <img className={styles.content__image} src="images/contents3.svg" alt="contents" />
          </li>
          <li className={styles.content}>
            <h2 className={styles.content__info__title}>
              저장한 링크를
            ...
            <img className={styles.content__image} src="images/contents4.svg" alt="contents" />
          </li>
        </ul>
      </section>
    </Layout>
